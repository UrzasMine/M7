...
Anhand dieser Graphik kann nun der berührungspunkt abgelesen werden, dieser befindet sich ca. bei 0,095 und 0,225. Damit ergibt sich als Gleitzahl $\epsilon$ 
\begin{equation}
    \centering
    \epsilon = .
\end{equation}
...
\end{equation}
gegeben.
Die Tabelle listet die Widerstandsbeiwerte im Vergleich zu den Literatur Werten auf.
