...
\hline
Zylinder  & 12,6 $\pm 1,2$\\
Zylinder & 24,6 $\pm 1,2$\\
Zylinder & 50,3 $\pm 1,2$\\
Tropfen $\left(\text{Spitz}\right)$ & $24,6 \pm 3,7$ \\
Tropfen $\left(\text{Rund}\right)$ & $24,6 \pm 3,7$ \\
Ball & 24,6 $\pm 3,7$ \\
Halbkugel & 24,6 $\pm 3,7$ \\
Schale & 24,6 $\pm 3,7$ \\
Auto & 9,8 $\pm 0,63$ \\
