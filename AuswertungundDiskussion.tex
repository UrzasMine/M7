...
\end{table}
Alle Werte weichen stark von den Literatur Werten ab und werden somit als nicht zuverlässig eingestuft. Fehlerquellen sind, der undichte Windkanal, die nicht perfekte Ausrichtung der Sonde, zu große Skalen Schritte und die nicht richtige Aufhänghöhe der Drucksonde. Dennoch lässt sich ein genereller Trend beim Vergleich zwischen den Literatur Werten und den gemessen Werten erkennen. Mit steigendem oder sinkenden Literaturwerten steigen oder sinken auch die ermittelten Werten.